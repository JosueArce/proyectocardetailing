...
function App() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      setBookings(prev => [{ ...form, cost, paymentStatus: result.paymentStatus || 'Pendiente', calendarEventId: result.eventId, id: Date.now(), status: 'Pendiente', createdAt: new Date().toISOString() }, ...prev])
